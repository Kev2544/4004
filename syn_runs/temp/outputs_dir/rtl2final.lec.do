...
# Generated on: Sat May 17 14:37:46 EDT 2025 (Sat May 17 18:37:46 UTC 2025)
...
set_log_file logs_dir/rtl2final.lec.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_mcs4_pad_frame_mv_db

read_implementation_information fv/mcs4_pad_frame -golden fv_map -revised mcs4_pad_frame_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/mcs4_pad_frame/fv_map.v.gz
elaborate_design -golden -root {mcs4_pad_frame}

read_design -verilog95   -revised -lastmod -noelab outputs_dir/mcs4_pad_frame_m.v
elaborate_design -revised -root {mcs4_pad_frame}

#add_name_alias fv/mcs4_pad_frame/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/mcs4_pad_frame/mcs4_pad_frame_mv.singlebit.original_name.alias.json.gz -revised
...
read_implementation_information fv/mcs4_pad_frame -revised fv_map
...
add_search_path ../../rtl/verilog -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k -f  ../../rtl/verilog/mcs4.f
elaborate_design -golden -root {mcs4_pad_frame} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mcs4_pad_frame/fv_map.v.gz
elaborate_design -revised -root {mcs4_pad_frame}
...
#add_name_alias fv/mcs4_pad_frame/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_dir/rtl2final.lec.log
}
