...
################################################################################
source outputs_May13-06:43:17/mcs4_opt.genus_init.tcl
read_metric -id current outputs_May13-06:43:17/mcs4_opt.metrics.json

phys::read_script outputs_May13-06:43:17/mcs4_opt.g
...
if {$_slk_ != "34179.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 34179.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:mcs4]]" != "{{mode:mcs4/view_mcs4_slow 40503.0} {mode:mcs4/view_mcs4_fast 34179.7}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:mcs4/view_mcs4_slow 40503.0} {mode:mcs4/view_mcs4_fast 34179.7}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:mcs4]]"
}
# tns
...
if {$_cell_area_ != "8002"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 8002,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "2872"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 2872,  current net area: $_net_area_"
}
unset _net_area_
