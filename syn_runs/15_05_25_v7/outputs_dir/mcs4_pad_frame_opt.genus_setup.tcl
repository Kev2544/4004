...
if {$_slk_ != "41459.6"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 41459.6,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:mcs4_pad_frame]]" != "{{mode:mcs4_pad_frame/view_mcs4_slow 41459.6} {mode:mcs4_pad_frame/view_mcs4_fast 56934.1}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:mcs4_pad_frame/view_mcs4_slow 41459.6} {mode:mcs4_pad_frame/view_mcs4_fast 56934.1}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:mcs4_pad_frame]]"
}
# tns
...
if {$_cell_area_ != "382208"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 382208,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "2558"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 2558,  current net area: $_net_area_"
}
unset _net_area_
