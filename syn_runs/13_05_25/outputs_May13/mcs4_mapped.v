...
// Generated on: May 13 2025 05:00:43 EDT (May 13 2025 09:00:43 UTC)
...
module mcs4(sysclk, poc_pad, clear_pad, p_out, io_pad);
  ...
  wire i4004_tio_board_L, i4004_tio_board_n_101, i4004_tio_board_n_104,
  ...
  wire n_1176, n_1177, n_1178, n_1179, n_1180, ram_0_a12, ram_0_io,
       ram_0_m12;
  wire ram_0_m22, ram_0_ram_sel, ram_0_src_ram_sel,
  ...
  wire ram_0_timing_recovery_m_56, ram_0_timing_recovery_m_57,
       ...
       ram_0_x22, ram_0_x32;
  wire rom_0_a12, rom_0_a32, rom_0_chipsel, rom_0_extbusdrive,
       rom_0_m11, rom_0_m12, rom_0_m21, rom_0_m22;
  wire rom_0_n_138, rom_0_n_139, rom_0_srcff,
  ...
  wire rom_0_timing_recovery_x_66, rom_0_x21, rom_0_x22, rom_1_chipsel,
       rom_1_extbusdrive, rom_1_n_139, rom_1_n_140, rom_1_srcff;
  wire shiftreg_cp_delayed, sync_pad;
  SDFFQX1 rom_1_n0161_reg(.CK (sysclk), .D (rom_1_n_140), .SI (n_1174),
       .SE (n_1158), .Q (rom_1_n_140));
  ...
  SDFFQX1 rom_0_n0161_reg(.CK (sysclk), .D (rom_0_n_139), .SI (n_1143),
       .SE (n_1157), .Q (rom_0_n_139));
  ...
  DFFQXL ram_0_src_ram_sel_reg(.CK (sysclk), .D (n_1151), .Q
       (ram_0_src_ram_sel));
  OA22X1 g17999__8428(.A0 (rom_1_n_140), .A1 (n_1173), .B0 (n_1142),
       .B1 (n_1173), .Y (n_1174));
  ...
  SDFFQX1 \i4004_tio_board_data_out_reg[1] (.CK (sysclk), .D (n_1153),
       .SI (i4004_tio_board_data_out[1]), .SE (n_774), .Q
       (i4004_tio_board_data_out[1]));
  SDFFQX1 \i4004_tio_board_data_out_reg[2] (.CK (sysclk), .D (n_1155),
       .SI (i4004_tio_board_data_out[2]), .SE (n_1158), .Q
       (i4004_tio_board_data_out[2]));
  SDFFQX1 \i4004_tio_board_data_out_reg[3] (.CK (sysclk), .D (n_1154),
       .SI (i4004_tio_board_data_out[3]), .SE (n_1158), .Q
       (i4004_tio_board_data_out[3]));
  SDFFQX1 \i4004_tio_board_data_out_reg[0] (.CK (sysclk), .D (n_1156),
       .SI (i4004_tio_board_data_out[0]), .SE (n_1157), .Q
  ...
  DFFHQX1 rom_0_chipsel_reg(.CK (sysclk), .D (n_1140), .Q
       (rom_0_chipsel));
  SDFFQX1 \i4004_ip_board_incr_in_reg[2] (.CK (sysclk), .D (n_1155),
       .SI (i4004_ip_board_incr_in[2]), .SE (n_1172), .Q
       (i4004_ip_board_incr_in[2]));
  SDFFQX1 \i4004_ip_board_incr_in_reg[3] (.CK (sysclk), .D (n_1154),
       .SI (i4004_ip_board_incr_in[3]), .SE (n_1172), .Q
       (i4004_ip_board_incr_in[3]));
  SDFFQX1 \i4004_ip_board_incr_in_reg[1] (.CK (sysclk), .D (n_1153),
       .SI (i4004_ip_board_incr_in[1]), .SE (n_1172), .Q
       (i4004_ip_board_incr_in[1]));
  SDFFQX1 \i4004_id_board_opr_reg[3] (.CK (sysclk), .D (n_1154), .SI
       (i4004_id_board_opr[3]), .SE (n_1152), .Q
       (i4004_id_board_opr[3]));
  SDFFQX1 \i4004_id_board_opr_reg[2] (.CK (sysclk), .D (n_1155), .SI
       (i4004_id_board_opr[2]), .SE (n_1152), .Q
       (i4004_id_board_opr[2]));
  SDFFQX1 \i4004_id_board_opr_reg[1] (.CK (sysclk), .D (n_1153), .SI
  ...
  SDFFQX2 \i4004_id_board_opa_reg[3] (.CK (sysclk), .D (n_1154), .SI
       (i4004_id_board_opa[3]), .SE (n_1164), .Q
       (i4004_id_board_opa[3]));
  EDFFHQX2 \i4004_id_board_opa_reg[0] (.CK (sysclk), .D (n_1156), .E
       (n_176), .Q (i4004_id_board_opa[0]));
  SDFFQX2 \i4004_id_board_opa_reg[1] (.CK (sysclk), .D (n_1153), .SI
       (i4004_id_board_opa[1]), .SE (n_1164), .Q
       (i4004_id_board_opa[1]));
  NOR3X1 g17801__8246(.A (ram_0_a12), .B (n_56), .C (n_1150), .Y
       (n_1151));
  DFFHQX1 ram_0_ram_sel_reg(.CK (sysclk), .D (n_1133), .Q
       (ram_0_ram_sel));
  AO21X1 g18048__7098(.A0 (n_1137), .A1 (n_1150), .B0 (n_118), .Y
       (n_1177));
  ...
  OAI2BB1X1 g17803__5115(.A0N (rom_1_chipsel), .A1N (n_1139), .B0
       (n_1132), .Y (n_1146));
  MXI2XL g17861__7482(.A (n_1156), .B (i4004_alu_board_tmp[0]), .S0
       (n_1147), .Y (n_1145));
  MXI2XL g17862__4733(.A (n_1153), .B (i4004_alu_board_tmp[1]), .S0
       (n_1147), .Y (n_1144));
  OA22X1 g18000__6161(.A0 (rom_0_n_139), .A1 (n_1141), .B0 (n_1142),
       .B1 (n_1141), .Y (n_1143));
  SDFFQX1 rom_1_srcff_reg(.CK (sysclk), .D (n_1131), .SI (rom_1_srcff),
       .SE (n_1135), .Q (rom_1_srcff));
  AND4X1 g18049__9315(.A (ram_0_x32), .B (n_1030), .C (n_20), .D
       (n_1042), .Y (n_1178));
  OAI2BB1X1 g17802__9945(.A0N (rom_0_chipsel), .A1N (n_1139), .B0
       (n_1090), .Y (n_1140));
  NOR3X1 g18172__2883(.A (n_1011), .B (n_1138), .C (n_1034), .Y
       (n_1173));
  DFFTRX2 \ram_0_opa_reg[1] (.CK (sysclk), .D (n_1031), .RN (n_1137),
       .Q (ram_0_opa[1]), .QN (UNCONNECTED));
  INVX1 g18106(.A (n_1156), .Y (n_1136));
  ...
  SDFFQX1 \ram_0_ram1_ram_array_reg[2][1] (.CK (sysclk), .D (n_1130),
       .SI (\ram_0_ram1_ram_array[2] [1]), .SE (n_1119), .Q
       (\ram_0_ram1_ram_array[2] [1]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[2][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram1_ram_array[2] [0]), .SE (n_1119), .Q
       (\ram_0_ram1_ram_array[2] [0]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[0][3] (.CK (sysclk), .D (n_1126),
       .SI (\ram_0_ram1_ram_array[0] [3]), .SE (n_1118), .Q
       (\ram_0_ram1_ram_array[0] [3]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[0][2] (.CK (sysclk), .D (n_1129),
       .SI (\ram_0_ram1_ram_array[0] [2]), .SE (n_1118), .Q
       (\ram_0_ram1_ram_array[0] [2]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[0][1] (.CK (sysclk), .D (n_1130),
       .SI (\ram_0_ram1_ram_array[0] [1]), .SE (n_1118), .Q
       (\ram_0_ram1_ram_array[0] [1]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[0][0] (.CK (sysclk), .D (n_1124),
  ...
  SDFFQX1 \ram_0_ram1_ram_array_reg[11][0] (.CK (sysclk), .D (n_1124),
  ...
  SDFFQX1 \ram_0_ram1_ram_array_reg[9][3] (.CK (sysclk), .D (n_1126),
  ...
  SDFFQX1 \ram_0_ram3_ram_array_reg[11][3] (.CK (sysclk), .D (n_1126),
       .SI (\ram_0_ram3_ram_array[11] [3]), .SE (n_1111), .Q
       (\ram_0_ram3_ram_array[11] [3]));
  SDFFQX1 \ram_0_ram3_ram_array_reg[11][1] (.CK (sysclk), .D (n_1130),
       .SI (\ram_0_ram3_ram_array[11] [1]), .SE (n_1111), .Q
       (\ram_0_ram3_ram_array[11] [1]));
  SDFFQX1 \ram_0_ram2_ram_array_reg[19][0] (.CK (sysclk), .D
       (\ram_0_ram2_ram_array[19] [0]), .SI (n_1124), .SE (n_1064), .Q
       (\ram_0_ram2_ram_array[19] [0]));
  SDFFQX1 \ram_0_ram3_ram_array_reg[11][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram3_ram_array[11] [0]), .SE (n_1111), .Q
       (\ram_0_ram3_ram_array[11] [0]));
  SDFFQX1 \ram_0_ram3_ram_array_reg[9][2] (.CK (sysclk), .D (n_1129),
  ...
  SDFFQX1 \ram_0_ram2_ram_array_reg[17][0] (.CK (sysclk), .D
       (\ram_0_ram2_ram_array[17] [0]), .SI (n_1124), .SE (n_1065), .Q
       (\ram_0_ram2_ram_array[17] [0]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[9][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram1_ram_array[9] [0]), .SE (n_1112), .Q
       (\ram_0_ram1_ram_array[9] [0]));
  SDFFQX1 \ram_0_ram3_ram_array_reg[9][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram3_ram_array[9] [0]), .SE (n_1110), .Q
       (\ram_0_ram3_ram_array[9] [0]));
  SDFFQX1 \ram_0_ram3_ram_array_reg[11][2] (.CK (sysclk), .D (n_1129),
       .SI (\ram_0_ram3_ram_array[11] [2]), .SE (n_1111), .Q
       (\ram_0_ram3_ram_array[11] [2]));
  SDFFQX1 \ram_0_ram2_ram_array_reg[13][0] (.CK (sysclk), .D
       (\ram_0_ram2_ram_array[13] [0]), .SI (n_1124), .SE (n_1066), .Q
       (\ram_0_ram2_ram_array[13] [0]));
  SDFFQX1 \ram_0_ram3_ram_array_reg[9][1] (.CK (sysclk), .D (n_1130),
       .SI (\ram_0_ram3_ram_array[9] [1]), .SE (n_1110), .Q
       (\ram_0_ram3_ram_array[9] [1]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[12][3] (.CK (sysclk), .D (n_1126),
       .SI (\ram_0_ram1_ram_array[12] [3]), .SE (n_1109), .Q
       (\ram_0_ram1_ram_array[12] [3]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[12][2] (.CK (sysclk), .D (n_1129),
       .SI (\ram_0_ram1_ram_array[12] [2]), .SE (n_1109), .Q
       (\ram_0_ram1_ram_array[12] [2]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[12][1] (.CK (sysclk), .D (n_1130),
  ...
  SDFFQX1 \ram_0_ram1_ram_array_reg[10][2] (.CK (sysclk), .D (n_1129),
       .SI (\ram_0_ram1_ram_array[10] [2]), .SE (n_1105), .Q
       (\ram_0_ram1_ram_array[10] [2]));
  SDFFQX1 \ram_0_ram2_ram_array_reg[2][0] (.CK (sysclk), .D
       (\ram_0_ram2_ram_array[2] [0]), .SI (n_1124), .SE (n_1072), .Q
       (\ram_0_ram2_ram_array[2] [0]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[10][3] (.CK (sysclk), .D (n_1126),
  ...
  SDFFQX1 \ram_0_ram3_ram_array_reg[14][3] (.CK (sysclk), .D (n_1126),
       .SI (\ram_0_ram3_ram_array[14] [3]), .SE (n_1104), .Q
       (\ram_0_ram3_ram_array[14] [3]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[14][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram1_ram_array[14] [0]), .SE (n_1103), .Q
       (\ram_0_ram1_ram_array[14] [0]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[14][1] (.CK (sysclk), .D (n_1130),
       .SI (\ram_0_ram1_ram_array[14] [1]), .SE (n_1103), .Q
       (\ram_0_ram1_ram_array[14] [1]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[14][2] (.CK (sysclk), .D (n_1129),
       .SI (\ram_0_ram1_ram_array[14] [2]), .SE (n_1103), .Q
       (\ram_0_ram1_ram_array[14] [2]));
  SDFFQX1 \ram_0_ram1_ram_array_reg[14][3] (.CK (sysclk), .D (n_1126),
  ...
  SDFFQX1 \ram_0_ram2_ram_array_reg[8][2] (.CK (sysclk), .D (n_1129),
       .SI (\ram_0_ram2_ram_array[8] [2]), .SE (n_1097), .Q
       (\ram_0_ram2_ram_array[8] [2]));
  SDFFQX1 \ram_0_ram2_ram_array_reg[8][3] (.CK (sysclk), .D (n_1126),
       .SI (\ram_0_ram2_ram_array[8] [3]), .SE (n_1097), .Q
       (\ram_0_ram2_ram_array[8] [3]));
  SDFFQX1 \ram_0_ram0_ram_array_reg[9][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram0_ram_array[9] [0]), .SE (n_1082), .Q
       (\ram_0_ram0_ram_array[9] [0]));
  SDFFQX1 \ram_0_ram2_ram_array_reg[10][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram2_ram_array[10] [0]), .SE (n_1096), .Q
       (\ram_0_ram2_ram_array[10] [0]));
  SDFFQX1 \ram_0_ram2_ram_array_reg[10][1] (.CK (sysclk), .D (n_1130),
  ...
  SDFFQX1 \ram_0_ram2_ram_array_reg[10][3] (.CK (sysclk), .D (n_1126),
       .SI (\ram_0_ram2_ram_array[10] [3]), .SE (n_1096), .Q
       (\ram_0_ram2_ram_array[10] [3]));
  SDFFQX1 \ram_0_ram0_ram_array_reg[8][0] (.CK (sysclk), .D (n_1124),
       .SI (\ram_0_ram0_ram_array[8] [0]), .SE (n_1095), .Q
       (\ram_0_ram0_ram_array[8] [0]));
  SDFFQX1 \ram_0_ram0_ram_array_reg[8][1] (.CK (sysclk), .D (n_1130),
       .SI (\ram_0_ram0_ram_array[8] [1]), .SE (n_1095), .Q
       (\ram_0_ram0_ram_array[8] [1]));
  SDFFQX1 \ram_0_ram0_ram_array_reg[8][2] (.CK (sysclk), .D (n_1129),
  ...
  SDFFQX1 \ram_0_ram1_ram_array_reg[13][0] (.CK (sysclk), .D (n_1124),
  ...
  SDFFQX1 \ram_0_ram2_ram_array_reg[7][0] (.CK (sysclk), .D
       (\ram_0_ram2_ram_array[7] [0]), .SI (n_1124), .SE (n_1067), .Q
  ...
  SDFFQX1 \ram_0_ram3_ram_array_reg[7][0] (.CK (sysclk), .D
       (\ram_0_ram3_ram_array[7] [0]), .SI (n_1124), .SE (n_1059), .Q
  ...
  SDFFQX1 \ram_0_ram0_ram_array_reg[2][0] (.CK (sysclk), .D
       (\ram_0_ram0_ram_array[2] [0]), .SI (n_1124), .SE (n_1048), .Q
  ...
  SDFFQX1 \ram_0_ram0_ram_array_reg[0][1] (.CK (sysclk), .D
       (\ram_0_ram0_ram_array[0] [1]), .SI (n_1130), .SE (n_1050), .Q
  ...
  SDFFQX1 \ram_0_ram0_ram_array_reg[3][1] (.CK (sysclk), .D
       (\ram_0_ram0_ram_array[3] [1]), .SI (n_1130), .SE (n_1047), .Q
       (\ram_0_ram0_ram_array[3] [1]));
  SDFFQX1 \ram_0_ram0_ram_array_reg[4][1] (.CK (sysclk), .D
       (\ram_0_ram0_ram_array[4] [1]), .SI (n_1130), .SE (n_1046), .Q
  ...
  NOR2X1 g17781__8428(.A (n_35), .B (n_1016), .Y (n_1039));
  NOR2X1 g17779__5526(.A (n_52), .B (n_1017), .Y (n_1038));
  NOR2X1 g17783__6783(.A (n_46), .B (n_1013), .Y (n_1037));
  ...
  SDFFQX1 i4004_id_board_n0405_reg(.CK (sysclk), .D
       (i4004_id_board_n_436), .SI (n_997), .SE (n_1158), .Q
  ...
  AND2X8 g17965__5477(.A (n_1137), .B (n_1033), .Y (n_1129));
  AND2X8 g17966__2398(.A (n_1137), .B (n_1026), .Y (n_1126));
  AND2X8 g17967__5107(.A (n_1137), .B (n_1138), .Y (n_1124));
  AND2X8 g17968__6260(.A (n_1137), .B (n_1035), .Y (n_1130));
  ...
  OAI22X1 g18001__4733(.A0 (i4004_id_board_n_437), .A1 (n_996), .B0
       (n_906), .B1 (n_996), .Y (n_997));
  ...
  AOI221X1 g17980__1666(.A0 (\i4004_sp_board_dram_array[1] [4]), .A1
       ...
       .C0 (n_882), .Y (n_907));
  NOR3X1 g18170__7410(.A (n_47), .B (n_906), .C (n_866), .Y (n_996));
  ...
  OAI221X1 g18227__6417(.A0 (n_193), .A1 (n_711), .B0 (n_194), .B1
  ...
  AOI31X1 g17997__9315(.A0 (i4004_alu_board_cy), .A1 (n_808), .A2
       (n_807), .B0 (n_310), .Y (n_845));
  NOR2X2 g18157__9945(.A (n_928), .B (n_844), .Y (n_944));
  NOR2X2 g18158__2883(.A (n_921), .B (n_844), .Y (n_951));
  NOR2X2 g18156__2346(.A (n_915), .B (n_844), .Y (n_960));
  ...
  SDFFQX1 i4004_ip_board_n0438_reg(.CK (sysclk), .D
       (i4004_ip_board_n_344), .SI (n_734), .SE (n_1157), .Q
  ...
  NAND2X1 g18070__4733(.A (\i4004_sp_board_dram_array[7] [7]), .B
       (n_819), .Y (n_815));
  OAI221X1 g18228__6161(.A0 (n_80), .A1 (n_739), .B0 (n_738), .B1
  ...
  TBUFX1 i4004_alu_board_g257__5115(.A (n_740), .OE (n_787), .Y
       (n_1155));
  TBUFX1 i4004_alu_board_g259__7482(.A (n_737), .OE (n_787), .Y
       (n_1156));
  ...
  SDFFQX1 i4004_id_board_n0362_reg(.CK (sysclk), .D
       (i4004_id_board_n_439), .SI (n_634), .SE (n_774), .Q
  ...
  AOI221X1 g18435__5526(.A0 (\ram_0_ram0_ram_array[18] [3]), .A1
       (n_746), .B0 (\ram_0_ram0_ram_array[19] [3]), .B1 (n_745), .C0
       (n_655), .Y (n_748));
  AOI221X1 g18438__6783(.A0 (\ram_0_ram0_ram_array[18] [1]), .A1
       (n_746), .B0 (\ram_0_ram0_ram_array[19] [1]), .B1 (n_745), .C0
       (n_671), .Y (n_747));
  AOI221X1 g18437__3680(.A0 (\ram_0_ram0_ram_array[18] [2]), .A1
       (n_746), .B0 (\ram_0_ram0_ram_array[19] [2]), .B1 (n_745), .C0
       (n_654), .Y (n_744));
  AOI221X1 g18436__1617(.A0 (\ram_0_ram0_ram_array[18] [0]), .A1
       (n_746), .B0 (\ram_0_ram0_ram_array[19] [0]), .B1 (n_745), .C0
       (n_658), .Y (n_743));
  OR4X1 g18296__2802(.A (n_8), .B (i4004_poc), .C (n_88), .D (n_659),
       .Y (n_788));
  INVX1 g18238(.A (n_921), .Y (n_865));
  TBUFX1 i4004_alu_board_g258__1705(.A (n_670), .OE (n_787), .Y
       (n_1153));
  NAND3X1 g18046__5122(.A (i4004_x32), .B (n_1030), .C (n_741), .Y
       (n_742));
  OAI221X1 g18226__8246(.A0 (n_79), .A1 (n_739), .B0 (n_738), .B1
  ...
  NOR2X2 g18211__4733(.A (n_725), .B (n_667), .Y (n_915));
  ...
  AOI221X1 g18546__2883(.A0 (\ram_0_ram0_ram_array[4] [0]), .A1
       (n_730), .B0 (\ram_0_ram0_ram_array[5] [0]), .B1 (n_729), .C0
       (n_552), .Y (n_731));
  AOI221X1 g18525__2346(.A0 (\ram_0_ram0_ram_array[4] [3]), .A1
       (n_730), .B0 (\ram_0_ram0_ram_array[5] [3]), .B1 (n_729), .C0
       (n_562), .Y (n_728));
  ...
  NOR2X2 g18252__5477(.A (n_725), .B (n_664), .Y (n_921));
  ...
  AOI221X1 g18521__8428(.A0 (\ram_0_ram2_ram_array[4] [1]), .A1
       (n_719), .B0 (\ram_0_ram2_ram_array[5] [1]), .B1 (n_718), .C0
       (n_466), .Y (n_720));
  AOI221X1 g18520__5526(.A0 (\ram_0_ram3_ram_array[12] [2]), .A1
       (n_716), .B0 (\ram_0_ram3_ram_array[13] [2]), .B1 (n_715), .C0
       (n_480), .Y (n_717));
  AOI221X1 g18519__6783(.A0 (\ram_0_ram1_ram_array[4] [1]), .A1
       (n_713), .B0 (\ram_0_ram1_ram_array[5] [1]), .B1 (n_712), .C0
       (n_461), .Y (n_714));
  AOI22X1 g18289__3680(.A0 (n_371), .A1 (n_518), .B0
       (i4004_id_board_opa[3]), .B1 (n_517), .Y (n_711));
  ...
  AOI221X1 g18516__5122(.A0 (\ram_0_ram3_ram_array[12] [1]), .A1
       (n_716), .B0 (\ram_0_ram3_ram_array[13] [1]), .B1 (n_715), .C0
       (n_477), .Y (n_707));
  AOI221X1 g18517__8246(.A0 (\ram_0_ram2_ram_array[12] [1]), .A1
       (n_705), .B0 (\ram_0_ram2_ram_array[13] [1]), .B1 (n_704), .C0
       (n_526), .Y (n_706));
  ...
  AOI221X1 g18528__9315(.A0 (\ram_0_ram2_ram_array[12] [0]), .A1
       (n_705), .B0 (\ram_0_ram2_ram_array[13] [0]), .B1 (n_704), .C0
       (n_447), .Y (n_698));
  ...
  AOI221X1 g18530__2883(.A0 (\ram_0_ram1_ram_array[12] [1]), .A1
       (n_695), .B0 (\ram_0_ram1_ram_array[13] [1]), .B1 (n_694), .C0
       (n_469), .Y (n_696));
  AOI221X1 g18536__2346(.A0 (\ram_0_ram1_ram_array[12] [2]), .A1
       (n_695), .B0 (\ram_0_ram1_ram_array[13] [2]), .B1 (n_694), .C0
       (n_450), .Y (n_693));
  ...
  AOI221X1 g18540__5477(.A0 (\ram_0_ram0_ram_array[12] [0]), .A1
       (n_686), .B0 (\ram_0_ram0_ram_array[13] [0]), .B1 (n_685), .C0
       (n_421), .Y (n_687));
  ...
  AOI221X1 g18544__6260(.A0 (\ram_0_ram1_ram_array[4] [3]), .A1
       (n_713), .B0 (\ram_0_ram1_ram_array[5] [3]), .B1 (n_712), .C0
       (n_423), .Y (n_682));
  AOI221X1 g18545__4319(.A0 (\ram_0_ram0_ram_array[12] [1]), .A1
       (n_686), .B0 (\ram_0_ram0_ram_array[13] [1]), .B1 (n_685), .C0
       (n_478), .Y (n_681));
  ...
  AOI221X1 g18549__5526(.A0 (\ram_0_ram2_ram_array[4] [3]), .A1
       (n_719), .B0 (\ram_0_ram2_ram_array[5] [3]), .B1 (n_718), .C0
       (n_429), .Y (n_679));
  ...
  ADDHX1 g18799__8246(.A (i4004_ip_board_incr_in[2]), .B (n_613), .CO
       (n_672), .S (n_922));
  AO22X1 g18505__7098(.A0 (\ram_0_ram0_ram_array[16] [1]), .A1 (n_657),
       .B0 (\ram_0_ram0_ram_array[17] [1]), .B1 (n_656), .Y (n_671));
  OAI221X1 g18221__6131(.A0 (n_669), .A1 (n_384), .B0 (n_738), .B1
  ...
  AO22X1 g18499__9315(.A0 (\ram_0_ram0_ram_array[16] [0]), .A1 (n_657),
       .B0 (\ram_0_ram0_ram_array[17] [0]), .B1 (n_656), .Y (n_658));
  AO22X1 g18495__9945(.A0 (\ram_0_ram0_ram_array[16] [3]), .A1 (n_657),
       .B0 (\ram_0_ram0_ram_array[17] [3]), .B1 (n_656), .Y (n_655));
  AO22X1 g18497__2883(.A0 (\ram_0_ram0_ram_array[16] [2]), .A1 (n_657),
       .B0 (\ram_0_ram0_ram_array[17] [2]), .B1 (n_656), .Y (n_654));
  ...
  AOI22X1 g18587__4319(.A0 (\ram_0_ram0_ram_array[2] [2]), .A1 (n_631),
       .B0 (\ram_0_ram0_ram_array[3] [2]), .B1 (n_630), .Y (n_635));
  OAI22X1 g17992__8428(.A0 (n_31), .A1 (n_633), .B0 (n_906), .B1
       (n_633), .Y (n_634));
  AOI22X1 g18665__5526(.A0 (\ram_0_ram0_ram_array[2] [0]), .A1 (n_631),
       .B0 (\ram_0_ram0_ram_array[3] [0]), .B1 (n_630), .Y (n_632));
  AOI22X1 g18652__6783(.A0 (\ram_0_ram0_ram_array[2] [3]), .A1 (n_631),
       .B0 (\ram_0_ram0_ram_array[3] [3]), .B1 (n_630), .Y (n_629));
  AOI22X1 g18569__3680(.A0 (\ram_0_ram0_ram_array[2] [1]), .A1 (n_631),
       .B0 (\ram_0_ram0_ram_array[3] [1]), .B1 (n_630), .Y (n_628));
  ...
  NAND3X2 g18050__5477(.A (rom_0_x22), .B (n_1030), .C (n_1088), .Y
       (n_1135));
  ...
  SDFFQX1 i4004_sp_board_n0592_reg(.CK (sysclk), .D
       (i4004_sp_board_n_305), .SI (n_330), .SE (n_1157), .Q
  ...
  AOI22X1 g18671__8428(.A0 (\ram_0_ram3_ram_array[10] [3]), .A1
       ...
       (n_612));
  AOI22X1 g18668__5526(.A0 (\ram_0_ram3_ram_array[2] [3]), .A1 (n_610),
       .B0 (\ram_0_ram3_ram_array[3] [3]), .B1 (n_609), .Y (n_611));
  OAI21X1 g18410__6783(.A0 (n_398), .A1 (n_399), .B0 (n_607), .Y
       (n_608));
  AO22X1 g18640__3680(.A0 (\ram_0_ram0_ram_array[6] [1]), .A1 (n_561),
       .B0 (\ram_0_ram0_ram_array[7] [1]), .B1 (n_560), .Y (n_606));
  ...
  AOI22X1 g18562__2346(.A0 (\ram_0_ram3_ram_array[10] [2]), .A1
       (n_581), .B0 (\ram_0_ram3_ram_array[11] [2]), .B1 (n_580), .Y
       (n_582));
  ...
  AOI22X1 g18567__7410(.A0 (\ram_0_ram2_ram_array[10] [0]), .A1
       (n_577), .B0 (\ram_0_ram2_ram_array[11] [0]), .B1 (n_576), .Y
       (n_578));
  AOI22X1 g18571__6417(.A0 (\ram_0_ram3_ram_array[10] [0]), .A1
       (n_581), .B0 (\ram_0_ram3_ram_array[11] [0]), .B1 (n_580), .Y
       (n_575));
  ...
  AOI22X1 g18575__2398(.A0 (\ram_0_ram2_ram_array[10] [2]), .A1
       (n_577), .B0 (\ram_0_ram2_ram_array[11] [2]), .B1 (n_576), .Y
       (n_573));
  AOI22X1 g18666__5107(.A0 (\ram_0_ram3_ram_array[10] [1]), .A1
       (n_581), .B0 (\ram_0_ram3_ram_array[11] [1]), .B1 (n_580), .Y
       (n_572));
  AOI22X1 g18581__6260(.A0 (\ram_0_ram3_ram_array[2] [1]), .A1 (n_610),
       .B0 (\ram_0_ram3_ram_array[3] [1]), .B1 (n_609), .Y (n_571));
  ...
  AOI22X1 g18591__8428(.A0 (\ram_0_ram0_ram_array[10] [2]), .A1
       (n_566), .B0 (\ram_0_ram0_ram_array[11] [2]), .B1 (n_565), .Y
       (n_567));
  ...
  AO22X1 g18619__3680(.A0 (\ram_0_ram0_ram_array[6] [3]), .A1 (n_561),
       .B0 (\ram_0_ram0_ram_array[7] [3]), .B1 (n_560), .Y (n_562));
  AOI22X1 g18620__1617(.A0 (\ram_0_ram1_ram_array[10] [2]), .A1
       (n_558), .B0 (\ram_0_ram1_ram_array[11] [2]), .B1 (n_557), .Y
       (n_559));
  ...
  AOI22X1 g18642__8246(.A0 (\ram_0_ram0_ram_array[10] [0]), .A1
       (n_566), .B0 (\ram_0_ram0_ram_array[11] [0]), .B1 (n_565), .Y
       (n_553));
  AO22X1 g18644__7098(.A0 (\ram_0_ram0_ram_array[6] [0]), .A1 (n_561),
       .B0 (\ram_0_ram0_ram_array[7] [0]), .B1 (n_560), .Y (n_552));
  AOI22X1 g18645__6131(.A0 (\ram_0_ram1_ram_array[10] [3]), .A1
       (n_558), .B0 (\ram_0_ram1_ram_array[11] [3]), .B1 (n_557), .Y
       (n_551));
  ...
  AOI22X1 g18647__5115(.A0 (\ram_0_ram0_ram_array[0] [0]), .A1 (n_547),
       .B0 (\ram_0_ram0_ram_array[1] [0]), .B1 (n_546), .Y (n_549));
  AOI22X1 g18648__7482(.A0 (\ram_0_ram0_ram_array[0] [2]), .A1 (n_547),
       .B0 (\ram_0_ram0_ram_array[1] [2]), .B1 (n_546), .Y (n_548));
  ...
  AOI22X1 g18654__9315(.A0 (\ram_0_ram0_ram_array[0] [3]), .A1 (n_547),
       .B0 (\ram_0_ram0_ram_array[1] [3]), .B1 (n_546), .Y (n_543));
  ...
  AO22X1 g18658__2883(.A0 (\ram_0_ram0_ram_array[6] [2]), .A1 (n_561),
       .B0 (\ram_0_ram0_ram_array[7] [2]), .B1 (n_560), .Y (n_541));
  AOI22X1 g18664__2346(.A0 (\ram_0_ram0_ram_array[0] [1]), .A1 (n_547),
       .B0 (\ram_0_ram0_ram_array[1] [1]), .B1 (n_546), .Y (n_540));
  ...
  NOR2X2 g18347__1666(.A (n_663), .B (n_662), .Y (n_741));
  ...
  AOI22X1 g18488__3680(.A0 (\ram_0_ram3_ram_array[18] [2]), .A1
       (n_524), .B0 (\ram_0_ram3_ram_array[19] [2]), .B1 (n_523), .Y
       (n_525));
  AOI22X1 g18487__1617(.A0 (\ram_0_ram3_ram_array[18] [0]), .A1
       (n_524), .B0 (\ram_0_ram3_ram_array[19] [0]), .B1 (n_523), .Y
       (n_522));
  ...
  AND2X1 g18319__8246(.A (n_517), .B (n_376), .Y (n_518));
  ...
  SDFFQX1 i4004_sp_board_n0615_reg(.CK (sysclk), .D
       (i4004_sp_board_n_304), .SI (n_309), .SE (n_1157), .Q
  ...
  OR2X1 g18331__2346(.A (n_15), .B (n_387), .Y (n_981));
  ...
  AOI22X1 g18579__7482(.A0 (\ram_0_ram3_ram_array[0] [1]), .A1 (n_473),
       .B0 (\ram_0_ram3_ram_array[1] [1]), .B1 (n_472), .Y (n_474));
  ...
  AOI22X1 g18585__2883(.A0 (\ram_0_ram3_ram_array[8] [0]), .A1 (n_464),
       .B0 (\ram_0_ram3_ram_array[9] [0]), .B1 (n_463), .Y (n_465));
  ...
  AOI22X1 g18594__5477(.A0 (\ram_0_ram1_ram_array[8] [1]), .A1 (n_455),
       .B0 (\ram_0_ram1_ram_array[9] [1]), .B1 (n_454), .Y (n_456));
  ...
  AOI22X1 g18621__4319(.A0 (\ram_0_ram1_ram_array[8] [2]), .A1 (n_455),
       .B0 (\ram_0_ram1_ram_array[9] [2]), .B1 (n_454), .Y (n_448));
  ...
  AOI22X1 g18631__8246(.A0 (\ram_0_ram0_ram_array[8] [2]), .A1 (n_434),
       .B0 (\ram_0_ram0_ram_array[9] [2]), .B1 (n_433), .Y (n_435));
  AOI22X1 g18633__7098(.A0 (\ram_0_ram3_ram_array[8] [3]), .A1 (n_464),
       .B0 (\ram_0_ram3_ram_array[9] [3]), .B1 (n_463), .Y (n_432));
  AOI22X1 g18636__6131(.A0 (\ram_0_ram3_ram_array[0] [3]), .A1 (n_473),
       .B0 (\ram_0_ram3_ram_array[1] [3]), .B1 (n_472), .Y (n_431));
  ...
  AOI22X1 g18656__9315(.A0 (\ram_0_ram0_ram_array[8] [0]), .A1 (n_434),
       .B0 (\ram_0_ram0_ram_array[9] [0]), .B1 (n_433), .Y (n_425));
  ...
  SDFFQX1 shiftreg_cp_delayed_reg(.CK (sysclk), .D
       (shiftreg_cp_delayed), .SI (n_1157), .SE (n_262), .Q
       (shiftreg_cp_delayed));
  ...
  SDFFQX1 \shiftreg_shifter_reg[9] (.CK (sysclk), .D (p_out[9]), .SI
       (p_out[8]), .SE (n_411), .Q (p_out[9]));
  SDFFQX1 \shiftreg_shifter_reg[4] (.CK (sysclk), .D (p_out[4]), .SI
       (p_out[3]), .SE (n_411), .Q (p_out[4]));
  SDFFQX1 \shiftreg_shifter_reg[0] (.CK (sysclk), .D (p_out[0]), .SI
       (oport[0]), .SE (n_411), .Q (p_out[0]));
  SDFFQX1 \shiftreg_shifter_reg[2] (.CK (sysclk), .D (p_out[2]), .SI
       (p_out[1]), .SE (n_411), .Q (p_out[2]));
  SDFFQX1 \shiftreg_shifter_reg[3] (.CK (sysclk), .D (p_out[3]), .SI
       (p_out[2]), .SE (n_411), .Q (p_out[3]));
  SDFFQX1 \shiftreg_shifter_reg[1] (.CK (sysclk), .D (p_out[1]), .SI
       (p_out[0]), .SE (n_411), .Q (p_out[1]));
  SDFFQX1 \shiftreg_shifter_reg[5] (.CK (sysclk), .D (p_out[5]), .SI
       (p_out[4]), .SE (n_411), .Q (p_out[5]));
  SDFFQX1 \shiftreg_shifter_reg[8] (.CK (sysclk), .D (p_out[8]), .SI
       (p_out[7]), .SE (n_411), .Q (p_out[8]));
  DFFHQX1 \shiftreg_cp_delay_reg[0] (.CK (sysclk), .D (n_341), .Q
       (shiftreg_cp_delay[0]));
  AND2X1 g17764__8428(.A (n_406), .B (n_101), .Y (n_410));
  NAND3X1 g18117__5526(.A (n_408), .B (n_505), .C (n_402), .Y (n_409));
  AND2XL g17755__6783(.A (n_406), .B (n_266), .Y (n_407));
  AND2XL g17756__3680(.A (n_406), .B (n_233), .Y (n_405));
  ...
  NOR3X1 g18174__8246(.A (n_49), .B (n_906), .C (n_311), .Y (n_633));
  ...
  EDFFX2 i4004_tio_board_L_reg(.CK (sysclk), .D (n_271), .E (n_1030),
       .Q (UNCONNECTED0), .QN (i4004_tio_board_L));
  SDFFQX1 \shiftreg_shifter_reg[6] (.CK (sysclk), .D (p_out[6]), .SI
       (p_out[5]), .SE (n_411), .Q (p_out[6]));
  SDFFQX1 \shiftreg_shifter_reg[7] (.CK (sysclk), .D (p_out[7]), .SI
       (p_out[6]), .SE (n_411), .Q (p_out[7]));
  NAND2X2 g18367__6131(.A (n_245), .B (n_359), .Y (n_662));
  NAND3BX2 g18297__1881(.AN (n_48), .B (i4004_alu_board_n_361), .C
       (n_388), .Y (n_616));
  AND2X1 g18608__5115(.A (n_331), .B (n_397), .Y (n_657));
  AND2X1 g18689__7482(.A (n_333), .B (n_397), .Y (n_630));
  ...
  NAND3BX1 g18312__4319(.AN (n_373), .B (n_372), .C (n_288), .Y
       (n_374));
  NAND3X2 g18386__8428(.A (i4004_id_board_opa[3]), .B (n_376), .C
       (n_371), .Y (n_517));
  ...
  AND2X1 g18606__5526(.A (n_296), .B (n_397), .Y (n_746));
  NOR2X2 g18598__6783(.A (n_368), .B (n_370), .Y (n_593));
  ...
  NOR2BX1 g18611__5122(.AN (n_369), .B (n_368), .Y (n_592));
  AND2X1 g18613__8246(.A (n_369), .B (n_361), .Y (n_596));
  AND2X1 g18686__7098(.A (n_295), .B (n_397), .Y (n_546));
  AND2X1 g18687__6131(.A (n_297), .B (n_397), .Y (n_560));
  NOR2X2 g18690__1881(.A (n_368), .B (n_366), .Y (n_609));
  NOR2X2 g18694__5115(.A (n_367), .B (n_366), .Y (n_584));
  NOR2X2 g18695__7482(.A (n_365), .B (n_366), .Y (n_568));
  NOR2X1 g18700__4733(.A (n_368), .B (n_364), .Y (n_581));
  ...
  NOR2BX1 g18723__1666(.AN (n_363), .B (n_368), .Y (n_580));
  AND2X1 g18731__7410(.A (n_360), .B (n_361), .Y (n_585));
  NOR2BX1 g18735__6417(.AN (n_360), .B (n_368), .Y (n_610));
  ...
  SDFFQX1 ram_0_timing_recovery_m12_reg(.CK (sysclk), .D (ram_0_m12),
       .SI (ram_0_timing_recovery_m_56), .SE (n_340), .Q (ram_0_m12));
  ...
  SDFFQX1 ram_0_timing_recovery_m22_reg(.CK (sysclk), .D (ram_0_m22),
       .SI (ram_0_timing_recovery_m_57), .SE (n_340), .Q (ram_0_m22));
  ...
  EDFFHQX2 i4004_tio_board_timing_generator_x12_reg(.CK (sysclk), .D
       (i4004_tio_board_timing_generator_x_68), .E (n_336), .Q
       (i4004_x12));
  INVX1 g18749(.A (n_366), .Y (n_333));
  NAND2X1 g17885__9945(.A (n_1030), .B (n_282), .Y (n_332));
  INVX1 g18675(.A (n_370), .Y (n_331));
  AO22X1 g17991__2883(.A0 (n_195), .A1 (n_329), .B0 (n_304), .B1
       (n_329), .Y (n_330));
  ...
  NOR2BX1 g18614__6417(.AN (n_328), .B (n_368), .Y (n_523));
  NOR2X1 g18710__5477(.A (n_327), .B (n_322), .Y (n_443));
  NOR2X1 g18682__2398(.A (n_365), .B (n_324), .Y (n_459));
  NOR2X1 g18683__5107(.A (n_368), .B (n_326), .Y (n_716));
  NOR2X1 g18684__6260(.A (n_327), .B (n_326), .Y (n_686));
  NOR2X1 g18685__4319(.A (n_367), .B (n_321), .Y (n_490));
  NOR2X1 g18688__8428(.A (n_367), .B (n_326), .Y (n_705));
  NOR2X2 g18691__5526(.A (n_368), .B (n_325), .Y (n_472));
  ...
  NOR2BX1 g18724__6417(.AN (n_320), .B (n_368), .Y (n_463));
  ...
  NOR2X1 g18728__6260(.A (n_365), .B (n_318), .Y (n_713));
  ...
  NOR2BX1 g18734__3680(.AN (n_317), .B (n_368), .Y (n_473));
  ...
  NOR2X1 g18741__8246(.A (n_367), .B (n_315), .Y (n_704));
  NOR2X1 g18742__7098(.A (n_365), .B (n_315), .Y (n_694));
  NOR2X1 g18743__6131(.A (n_327), .B (n_314), .Y (n_729));
  NOR2X1 g18744__1881(.A (n_368), .B (n_314), .Y (n_689));
  NOR2X1 g18745__5115(.A (n_367), .B (n_314), .Y (n_718));
  NOR2X1 g18746__7482(.A (n_365), .B (n_314), .Y (n_712));
  NOR2X2 g18602__4733(.A (n_368), .B (n_313), .Y (n_524));
  ...
  NOR2X1 g18112__7410(.A (n_669), .B (n_235), .Y (n_310));
  ...
  OR4X1 g18269__2398(.A (i4004_m12), .B (n_202), .C (n_306), .D
       (n_305), .Y (n_402));
  OAI31X2 g18270__5107(.A0 (n_304), .A1 (n_12), .A2 (n_249), .B0
       (n_251), .Y (n_505));
  SDFFQX1 rom_1_extbusdrive_reg(.CK (sysclk), .D (n_175), .SI
       (rom_1_extbusdrive), .SE (n_774), .Q (rom_1_extbusdrive));
  SDFFQX1 rom_0_extbusdrive_reg(.CK (sysclk), .D (n_168), .SI
       (rom_0_extbusdrive), .SE (n_1157), .Q (rom_0_extbusdrive));
  ...
  OR3X1 g18064__6783(.A (i4004_sp_board_row[0]), .B (n_243), .C
       (n_210), .Y (n_504));
  SDFFQX2 clockgen_clk2_reg(.CK (sysclk), .D (n_337), .SI (n_1157), .SE
       (n_180), .Q (clk2_pad));
  ...
  INVX1 g18766(.A (n_324), .Y (n_297));
  INVX1 g18674(.A (n_313), .Y (n_296));
  INVX1 g18750(.A (n_325), .Y (n_295));
  ...
  SDFFQX1 i4004_tio_board_timing_generator_a11_reg(.CK (sysclk), .D
       ...
       (n_774), .Q (i4004_tio_board_timing_generator_a_63));
  NAND2X2 g18203__5526(.A (n_268), .B (n_278), .Y (n_808));
  INVX1 g18213(.A (n_861), .Y (n_928));
  OR3X1 g18059__6783(.A (i4004_sp_board_row[2]), .B (n_67), .C (n_277),
       .Y (n_412));
  OR2X2 g18096__3680(.A (n_303), .B (n_273), .Y (n_643));
  OR3X1 g18063__1617(.A (n_244), .B (n_66), .C (n_277), .Y (n_413));
  ...
  AND2X2 g17964__5115(.A (n_1030), .B (n_261), .Y (n_411));
  OAI221X1 g17990__7482(.A0 (n_270), .A1 (n_224), .B0 (n_270), .B1
       (n_1021), .C0 (n_178), .Y (n_271));
  OAI22X1 g18374__4733(.A0 (n_172), .A1 (n_267), .B0 (n_268), .B1
       (n_267), .Y (n_269));
  ...
  SDFFQX1 \rom_1_data_out_reg[2] (.CK (sysclk), .D (n_124), .SI
       (rom_1_data_out[2]), .SE (n_1157), .Q (rom_1_data_out[2]));
  SDFFQX1 \rom_1_data_out_reg[3] (.CK (sysclk), .D (n_122), .SI
       (rom_1_data_out[3]), .SE (n_774), .Q (rom_1_data_out[3]));
  SDFFQX1 \rom_1_data_out_reg[1] (.CK (sysclk), .D (n_108), .SI
       (rom_1_data_out[1]), .SE (n_1157), .Q (rom_1_data_out[1]));
  SDFFQX1 \rom_0_data_out_reg[3] (.CK (sysclk), .D (n_123), .SI
       (rom_0_data_out[3]), .SE (n_1158), .Q (rom_0_data_out[3]));
  SDFFQX1 \rom_1_data_out_reg[0] (.CK (sysclk), .D (n_126), .SI
       (rom_1_data_out[0]), .SE (n_1158), .Q (rom_1_data_out[0]));
  SDFFQX1 \rom_0_data_out_reg[1] (.CK (sysclk), .D (n_128), .SI
       (rom_0_data_out[1]), .SE (n_1158), .Q (rom_0_data_out[1]));
  SDFFQX1 \rom_0_data_out_reg[0] (.CK (sysclk), .D (n_120), .SI
       (rom_0_data_out[0]), .SE (n_1157), .Q (rom_0_data_out[0]));
  NAND3X2 g18152__6161(.A (i4004_x12), .B (i4004_id_board_opa[0]), .C
       (n_246), .Y (n_329));
  OR3X1 g18139__9315(.A (i4004_ip_board_n_344), .B (n_111), .C (n_150),
       .Y (n_335));
  DFFHQX1 \i4004_ip_board_row_reg[1] (.CK (sysclk), .D (n_167), .Q
       (i4004_ip_board_row[1]));
  OA22X1 g18235__9945(.A0 (n_55), .A1 (n_245), .B0 (n_16), .B1 (n_725),
       .Y (n_861));
  ...
  AOI211X1 g18439__5122(.A0 (n_141), .A1 (n_223), .B0 (i4004_dc), .C0
       (n_906), .Y (n_375));
  NOR4X2 g18420__8246(.A (i4004_alu_board_acc_out[3]), .B
       (i4004_alu_board_acc_out[0]), .C (i4004_alu_board_acc_out[1]),
       .D (n_222), .Y (n_351));
  SDFFQX1 \rom_0_data_out_reg[2] (.CK (sysclk), .D (n_121), .SI
       (rom_0_data_out[2]), .SE (n_774), .Q (rom_0_data_out[2]));
  ...
  NAND2X1 g18075__2398(.A (i4004_sp_board_row[2]), .B (n_241), .Y
       (n_211));
  NAND2X1 g18076__5107(.A (i4004_sp_board_row[2]), .B (n_241), .Y
       (n_210));
  ...
  SDFFQX1 \ram_0_rfsh_next_reg[1] (.CK (sysclk), .D
       ...
       (ram_0_rfsh_next[1]));
  NOR3X1 g18278__1617(.A (ram_0_opa[3]), .B (n_9), .C (n_110), .Y
       (n_279));
  ...
  SDFFQX1 rom_0_timing_recovery_a21_reg(.CK (sysclk), .D
       (rom_0_timing_recovery_a_54), .SI (rom_0_a12), .SE (n_1158), .Q
  ...
  SDFFQX1 rom_0_timing_recovery_a31_reg(.CK (sysclk), .D
       ...
       .SE (n_774), .Q (rom_0_timing_recovery_a_55));
  SDFFQX1 rom_0_timing_recovery_a11_reg(.CK (sysclk), .D
       (rom_0_timing_recovery_a_53), .SI (sync_pad), .SE (n_1158), .Q
       (rom_0_timing_recovery_a_53));
  SDFFQX1 i4004_ip_board_n0374_reg(.CK (sysclk), .D
       (i4004_ip_board_n_347), .SI (n_145), .SE (n_774), .Q
  ...
  SDFFQX1 i4004_tio_board_timing_generator_a21_reg(.CK (sysclk), .D
       ...
       (n_1158), .Q (i4004_tio_board_timing_generator_a_64));
  SDFFQX1 i4004_id_board_n0414_reg(.CK (sysclk), .D
       (i4004_id_board_n_442), .SI (i4004_a22), .SE (n_774), .Q
  ...
  NOR2X1 g17873__5122(.A (n_117), .B (n_53), .Y (n_168));
  ...
  SDFFQX1 i4004_tio_board_timing_generator_x21_reg(.CK (sysclk), .D
       ...
       (n_1157), .Q (i4004_tio_board_timing_generator_x_69));
  OR4X1 g18343__6161(.A (i4004_id_board_opa[1]), .B (n_376), .C (n_82),
       .D (n_380), .Y (n_240));
  NOR3X1 g18346__9315(.A (n_61), .B (n_157), .C (n_380), .Y (n_306));
  INVX1 g18143(.A (n_241), .Y (n_277));
  SDFFQX1 i4004_id_board_n0380_reg(.CK (sysclk), .D
       (i4004_id_board_n_441), .SI (n_304), .SE (n_1157), .Q
  ...
  SDFFQX1 i4004_tio_board_timing_generator_m11_reg(.CK (sysclk), .D
       ...
       (n_1157), .Q (i4004_tio_board_timing_generator_m_66));
  OR4X1 g18403__9945(.A (i4004_id_board_opa[3]), .B (n_156), .C (n_69),
       .D (n_380), .Y (n_221));
  SDFFQX1 i4004_tio_board_n0699_reg(.CK (sysclk), .D
       (i4004_tio_board_L), .SI (i4004_tio_board_n_105), .SE (n_1157),
  ...
  OR4X1 g18389__7410(.A (n_196), .B (n_376), .C (n_77), .D (n_380), .Y
       (n_307));
  OAI31X2 g18205__6417(.A0 (i4004_tio_board_n_105), .A1 (n_85), .A2
  ...
  NOR2X1 g18366__6417(.A (n_68), .B (n_149), .Y (n_663));
  ...
  ADDHX1 g18806__5107(.A (shiftreg_cp_delay[0]), .B (n_5), .CO (n_129),
       .S (n_130));
  AO22X1 g18007__6260(.A0 (n_127), .A1 (io_pad[1]), .B0 (rom_0_n_138),
       .B1 (io_pad[1]), .Y (n_128));
  AO22X1 g18022__4319(.A0 (n_125), .A1 (io_pad[4]), .B0 (rom_1_n_139),
       .B1 (io_pad[4]), .Y (n_126));
  AO22X1 g18023__8428(.A0 (n_125), .A1 (io_pad[6]), .B0 (rom_1_n_139),
       .B1 (io_pad[6]), .Y (n_124));
  AO22X1 g18024__5526(.A0 (n_127), .A1 (io_pad[3]), .B0 (rom_0_n_138),
       .B1 (io_pad[3]), .Y (n_123));
  AO22X1 g18025__6783(.A0 (n_125), .A1 (io_pad[7]), .B0 (rom_1_n_139),
       .B1 (io_pad[7]), .Y (n_122));
  AO22X1 g18020__3680(.A0 (n_127), .A1 (io_pad[2]), .B0 (rom_0_n_138),
       .B1 (io_pad[2]), .Y (n_121));
  AO22X1 g18019__1617(.A0 (n_127), .A1 (io_pad[0]), .B0 (rom_0_n_138),
       .B1 (io_pad[0]), .Y (n_120));
  NOR3X1 g18263__2802(.A (i4004_sp_board_n_305), .B (n_64), .C (n_43),
       .Y (n_119));
  OAI22X1 g18118__1705(.A0 (ram_0_x32), .A1 (poc_pad), .B0 (n_1030),
       .B1 (poc_pad), .Y (n_118));
  ...
  SDFFQX1 i4004_ip_board_addr_ptr_1_master_reg(.CK (sysclk), .D
       ...
       (i4004_ip_board_addr_ptr_1_master));
  XNOR2X1 g18129__7098(.A (n_1030), .B (shiftreg_cp_delayed), .Y
       (n_257));
  OR2X1 g18088__6131(.A (n_113), .B (n_72), .Y (n_1015));
  AOI22X2 g18268__1881(.A0 (i4004_tio_board_n_104), .A1 (n_62), .B0
       (n_112), .B1 (n_78), .Y (n_1020));
  DFFSHQX2 i4004_tio_board_poc_reg(.SN (n_1137), .CK (sysclk), .D
       (n_81), .Q (i4004_poc));
  INVX1 g18867(.A (n_103), .Y (n_111));
  OAI211X1 g18310__5115(.A0 (ram_0_opa[2]), .A1 (n_63), .B0 (ram_0_io),
       .C0 (n_109), .Y (n_110));
  AO22X1 g18026__7482(.A0 (n_125), .A1 (io_pad[5]), .B0 (rom_1_n_139),
       .B1 (io_pad[5]), .Y (n_108));
  ...
  MX3X1 g18795__2883(.A (ram_0_char_num[1]), .B (ram_0_opa[1]), .C
       ...
       (n_190));
  NOR3X2 g18284__2346(.A (n_42), .B (n_27), .C (i4004_sp_board_n_304),
       .Y (n_205));
  OR4X1 g18316__1666(.A (n_50), .B (n_4), .C (i4004_poc), .D (n_75), .Y
       (n_726));
  MX3X1 g18789__7410(.A (ram_0_char_num[0]), .B (ram_0_opa[0]), .C
       (ram_0_rfsh_addr[0]), .S0 (ram_0_opa[2]), .S1 (poc_pad), .Y
       (n_502));
  MX2X1 g18790__6417(.A (n_10), .B (n_30), .S0 (n_3), .Y (n_276));
  ...
  NOR2X1 g18273__6260(.A (i4004_ip_board_n_347), .B (n_65), .Y (n_98));
  ...
  SDFFQX1 \ram_0_rfsh_addr_reg[3] (.CK (sysclk), .D
       ...
       .Q (ram_0_rfsh_addr[3]));
  OR3X1 g18212__1705(.A (n_44), .B (n_1167), .C (n_725), .Y (n_1152));
  ...
  OR3X1 g18165__5122(.A (n_29), .B (n_272), .C (n_725), .Y (n_1164));
  NOR2X1 g18301__8246(.A (n_28), .B (n_725), .Y (n_93));
  AOI21X1 g18409__7098(.A0 (ram_0_opa[1]), .A1 (n_91), .B0 (n_41), .Y
       (n_92));
  AOI21X1 g18376__6131(.A0 (n_112), .A1 (n_6), .B0
  ...
  NOR2X1 g18305__2883(.A (n_83), .B (n_252), .Y (n_162));
  ...
  NOR2BX1 g18304__1666(.AN (n_83), .B (n_252), .Y (n_163));
  ...
  BUFX2 g18869(.A (n_78), .Y (n_85));
  NOR3X1 g18198__3680(.A (i4004_x12), .B (i4004_x22), .C (i4004_m22),
       .Y (n_144));
  BUFX2 g18877(.A (n_1030), .Y (n_1158));
  BUFX2 g18876(.A (n_1030), .Y (n_774));
  BUFX4 g18878(.A (n_1030), .Y (n_1157));
  ...
  TBUFX2 rom_0_g60(.A (rom_0_data_out[3]), .OE (rom_0_extbusdrive), .Y
       (n_1026));
  INVX1 g18835(.A (n_280), .Y (n_70));
  NAND2X1 g18445(.A (i4004_id_board_opa[1]), .B
       (i4004_id_board_opa[0]), .Y (n_69));
  INVX1 g18831(.A (n_280), .Y (n_68));
  NAND2X1 g18074(.A (i4004_sp_board_row[1]), .B
       (i4004_sp_board_row[0]), .Y (n_67));
  NAND2X1 g18077(.A (i4004_sp_board_row[1]), .B
       (i4004_sp_board_row[0]), .Y (n_66));
  INVX1 g18874(.A (n_725), .Y (n_65));
  INVX1 g18880(.A (n_725), .Y (n_64));
  NOR2X1 g18359(.A (ram_0_opa[1]), .B (ram_0_opa[0]), .Y (n_63));
  INVX1 g18873(.A (n_725), .Y (n_62));
  NAND2X1 g18358(.A (i4004_id_board_opa[1]), .B
       (i4004_id_board_opa[0]), .Y (n_61));
  ...
  NOR2BX1 g18318(.AN (i4004_tio_board_data_out[2]), .B (i4004_poc), .Y
       (n_57));
  INVX1 g18846(.A (n_1137), .Y (n_56));
  NAND2X1 g18276(.A (i4004_x22), .B (clk2_pad), .Y (n_55));
  INVX1 g18847(.A (n_1137), .Y (n_54));
  INVX1 g18854(.A (n_1137), .Y (n_53));
  INVX1 g18851(.A (n_1137), .Y (n_52));
  INVX1 g18837(.A (n_280), .Y (n_51));
  INVX1 g18830(.A (n_280), .Y (n_50));
  INVX1 g18834(.A (n_280), .Y (n_49));
  NAND2X1 g18303(.A (i4004_alu_board_n_363), .B
       (i4004_alu_board_n_362), .Y (n_48));
  BUFX2 g18870(.A (n_39), .Y (n_78));
  NOR2X1 g18153(.A (i4004_m12), .B (i4004_a32), .Y (n_178));
  NAND2X2 g18765(.A (ram_0_reg_num[1]), .B (ram_0_reg_num[0]), .Y
       (n_323));
  ...
  INVX1 g18833(.A (n_280), .Y (n_47));
  INVX1 g18848(.A (n_1137), .Y (n_46));
  INVX1 g18852(.A (n_1137), .Y (n_45));
  INVX1 g18838(.A (n_280), .Y (n_44));
  INVX1 g18839(.A (n_280), .Y (n_43));
  INVX1 g18881(.A (n_725), .Y (n_42));
  NAND2X1 g18427(.A (ram_0_opa[3]), .B (ram_0_io), .Y (n_41));
  INVX1 g18859(.A (n_39), .Y (n_40));
  NOR2BX1 g18321(.AN (i4004_tio_board_data_out[0]), .B (i4004_poc), .Y
       (n_38));
  INVX1 g18853(.A (n_1137), .Y (n_37));
  NOR2X1 g17874(.A (i4004_x22), .B (i4004_m22), .Y (n_36));
  INVX1 g18850(.A (n_1137), .Y (n_35));
  INVX1 g18849(.A (n_1137), .Y (n_34));
  INVX1 g18845(.A (n_1137), .Y (n_33));
  AND2X1 g18811(.A (shiftreg_cp_delay[1]), .B (shiftreg_cp_delay[0]),
       .Y (n_32));
  INVX1 g18832(.A (n_280), .Y (n_31));
  NAND2BX1 g18797(.AN (ram_0_opa[2]), .B (ram_0_char_num[3]), .Y
       (n_30));
  INVX1 g18836(.A (n_280), .Y (n_29));
  INVX1 g18840(.A (n_280), .Y (n_28));
  INVX1 g18841(.A (n_280), .Y (n_27));
  INVX1 g18842(.A (n_280), .Y (n_26));
  ...
  NOR2X1 g18476(.A (i4004_id_board_opa[2]), .B (i4004_id_board_opa[1]),
       .Y (n_86));
  INVX2 g18879(.A (n_725), .Y (n_1030));
  INVX1 g18858(.A (poc_pad), .Y (n_25));
  ...
  INVX1 g18856(.A (poc_pad), .Y (n_20));
  INVX1 g18889(.A (i4004_id_board_n_436), .Y (n_19));
  INVX1 g18903(.A (i4004_ip_board_addr_ptr_0_slave), .Y (n_18));
  INVX1 g18815(.A (clockgen_clockdiv[4]), .Y (n_17));
  INVX1 g18820(.A (i4004_a32), .Y (n_16));
  INVX1 g18887(.A (clk2_pad), .Y (n_15));
  INVX1 g18895(.A (ram_0_rfsh_addr[0]), .Y (n_14));
  INVX1 g18890(.A (\i4004_ip_board_dram_array[3] [11]), .Y (n_13));
  INVX1 g18885(.A (clk2_pad), .Y (n_12));
  INVX1 g18898(.A (ram_0_rfsh_addr[2]), .Y (n_11));
  INVX1 g18893(.A (ram_0_rfsh_addr[3]), .Y (n_10));
  INVX1 g18883(.A (clk2_pad), .Y (n_9));
  INVX1 g18884(.A (clk2_pad), .Y (n_8));
  BUFX2 g18871(.A (clk1_pad), .Y (n_39));
  INVX1 g18912(.A (ram_0_m22), .Y (n_113));
  INVX1 g18896(.A (i4004_tio_board_L), .Y (n_112));
  INVX1 g18917(.A (i4004_x12), .Y (n_270));
  ...
  INVX1 g18907(.A (i4004_m22), .Y (n_272));
  ...
  INVX2 g18882(.A (clk2_pad), .Y (n_725));
endmodule
