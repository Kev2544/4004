...
# Generated on: Tue May 13 05:00:46 EDT 2025 (Tue May 13 09:00:46 UTC 2025)
...
set_log_file logs_May13-04:59:22/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mcs4 -revised fv_map
...
elaborate_design -golden -root {mcs4} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mcs4/fv_map.v.gz
...
#add_name_alias fv/mcs4/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_May13-04:59:22/rtl2intermediate.lec.log
}
