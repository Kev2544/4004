...
#  Generated on:      Thu May 15 02:07:25 2025
#  Design:            mcs4
...
#   My_CLK (period 50.000ns) in timing_config ConstraintMode_WC([../../release/v0.0.4/mcs4_opt.CM_mcs4_slow.sdc])
#   My_CLK (period 60.000ns) in timing_config ConstraintMode_BC([../../release/v0.0.4/mcs4_opt.CM_mcs4_fast.sdc])
...
# Skew group to balance non generated clock:My_CLK in timing_config:ConstraintMode_WC (sdc ../../release/v0.0.4/mcs4_opt.CM_mcs4_slow.sdc)
...
# Skew group to balance non generated clock:My_CLK in timing_config:ConstraintMode_BC (sdc ../../release/v0.0.4/mcs4_opt.CM_mcs4_fast.sdc)
