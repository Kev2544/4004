...
create_clock [get_ports {sysclk}]  -name My_CLK -period 60.000000 -waveform {0.000000 30.000000}
...
set_clock_transition  -fall -max 3 [get_clocks {My_CLK}]
...
set_input_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {poc_pad}]
set_input_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VDD_IOR}]
set_input_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {clear_pad}]
set_input_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VDD}]
set_input_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VSS_IOR}]
set_input_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VSS}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[8]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[6]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[7]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[4]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[5]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[2]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[3]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VDD_IOR}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[0]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[1]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VDD}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[9]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[7]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VSS_IOR}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[5]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[6]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[3]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[4]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {p_out[1]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[2]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {io_pad[0]}]
set_output_delay -add_delay 0.6 -clock [get_clocks {My_CLK}] [get_ports {VSS}]
set_clock_uncertainty 0.3 -hold [get_clocks {My_CLK}]
set_clock_uncertainty 0.6 -setup [get_clocks {My_CLK}]
