...
set_input_delay -clock [get_clocks $EXTCLK] -add_delay 1000.0 -name I_DELAY [get_ports -filter "(direction == in || direction == inout) && name != sysclk"]

# Output delay definition
set_output_delay -clock [get_clocks $EXTCLK] -add_delay 1000.0 -name O_DELAY [get_ports -filter "direction == out || direction == inout"]
